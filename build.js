  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16">
      <div class="flex items-center gap-3">
        <span class="text-sm tracking-tight hidden sm:block" style="color: var(--fg-primary); font-weight: 400;">Goldenflitch</span>
      </div>
...
<footer class="border-t py-12 nav-caps" style="background: var(--bg-primary); border-color: rgba(42,75,138,0.15);">
  <div class="max-w-6xl mx-auto px-6 text-center">
    <div class="flex items-center justify-center mb-4">
      <span class="text-sm" style="color: var(--fg-primary); font-weight: 400;">Goldenflitch</span>
    </div>
