...
<section id="architecture" class="relative py-24" style="background: rgba(42,75,138,0.03);">
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="reveal rounded-2xl p-8 max-w-3xl mx-auto text-center" style="background: var(--fg-primary);">
      ...
      <h3 class="text-xl font-medium mb-2" style="color: #DDE5EE; font-family: 'Inter', sans-serif;">Zero Data Egress Architecture</h3>
...
<section id="agents" class="relative py-24">
  <div class="relative max-w-6xl mx-auto px-6">
    ...
    <!-- Agent cards in folds -->
    <div class="reveal space-y-20">
      <div>
        <div class="grid lg:grid-cols-2 gap-6">
          <div class="glass rounded-2xl p-8">
            <div class="flex items-end gap-4 mb-6">
              <span class="text-4xl sm:text-5xl font-normal leading-none gradient-text" style="font-family: 'Inter', sans-serif;">1</span>
              <div><h3 class="font-normal text-2xl sm:text-3xl" style="color: var(--fg-primary); font-family: 'Inter', sans-serif;">Documentation Retrieval</h3><p class="text-xs" style="color: var(--fg-secondary);">Llama 3 70B — Read-Only Access</p></div>
            </div>
  ...
  <span class="prop">"status"</span>: <span class="string">"SUFFICIENT — proceed to Agent 2"</span>
      ...
      <div>
        <div class="grid lg:grid-cols-2 gap-6">
          <div class="glass rounded-2xl p-8">
            <div class="flex items-end gap-4 mb-6">
              <span class="text-4xl sm:text-5xl font-normal leading-none gradient-text" style="font-family: 'Inter', sans-serif;">2</span>
              <div><h3 class="font-normal text-2xl sm:text-3xl" style="color: var(--fg-primary); font-family: 'Inter', sans-serif;">Test of Effectiveness</h3><p class="text-xs" style="color: var(--fg-secondary);">Mixtral 8×7B — Statistical + ML</p></div>
            </div>
            <ul class="space-y-3 text-sm" style="color: var(--fg-primary);">
  ...
  <span class="prop">"processing_time"</span>: <span class="string">"12m 24s"</span>
      ...
      <div>
        <div class="grid lg:grid-cols-2 gap-6">
          <div class="glass rounded-2xl p-8">
            <div class="flex items-end gap-4 mb-6">
              <span class="text-4xl sm:text-5xl font-normal leading-none gradient-text" style="font-family: 'Inter', sans-serif;">3</span>
              <div><h3 class="font-normal text-2xl sm:text-3xl" style="color: var(--fg-primary); font-family: 'Inter', sans-serif;">Test of Design</h3><p class="text-xs" style="color: var(--fg-secondary);">Llama 3 70B — COSO Analysis</p></div>
            </div>
            <ul class="space-y-3 text-sm" style="color: var(--fg-primary);">
      ...
      <div>
        <div class="grid lg:grid-cols-2 gap-6">
          <div class="glass rounded-2xl p-8">
            <div class="flex items-end gap-4 mb-6">
              <span class="text-4xl sm:text-5xl font-normal leading-none gradient-text" style="font-family: 'Inter', sans-serif;">4</span>
              <div><h3 class="font-normal text-2xl sm:text-3xl" style="color: var(--fg-primary); font-family: 'Inter', sans-serif;">Supervisory Agent</h3><p class="text-xs" style="color: var(--fg-secondary);">Llama 3 70B — Orchestration + NLU — <span style="color: var(--accent);" class="font-semibold">$0 cost</span></p></div>
            </div>
            <ul class="space-y-3 text-sm" style="color: var(--fg-primary);">
